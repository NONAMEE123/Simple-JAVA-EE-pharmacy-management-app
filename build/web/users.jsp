      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Affiche_users">Utilisateurs</a></li>
...
%>            <li><a href="login.jsp">Logout</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Utilisateurs <small>Gérer Votre Site</small></h1>
          </div>
          <div class="col-md-2">
...
//-->
          ...
          <div class="col-md-9">
              ...
              <ul class="pager" style="margin-top:0;">
                                ...
                                <a  href="form_users.jsp" type="button" ><span class="glyphicon glyphicon-plus"> Ajouter Un Utilisateur</span></a>
                                </li>
                            </ul>
                    </div>
...
%>
	<tr><td><%=adminn.getId() %></td><td><%= adminn.getNom() %></td><td><%=adminn.getPrenom() %></td><td><%=adminn.getEmail() %></td><td><a href="edit_users.jsp?id=<%=adminn.getId() %>" class="btn btn-sm btn-success">Modifier</a> <a href="delete_users?id=<%=adminn.getId() %>" class="btn btn-sm btn-danger">Supprimer</a></td></tr>
<%
	}
%>
                    </table>
