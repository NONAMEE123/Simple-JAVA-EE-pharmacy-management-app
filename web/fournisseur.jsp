      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Affiche_fournissuer">Fournisseur</a></li>
...
%>            <li><a href="login.html">Logout</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Fournisseurs <small>Gérer Votre Site</small></h1>
          </div>
          <div class="col-md-2">
...
//-->
          ...
          <div class="col-md-9">
              ...
              <ul class="pager" style="margin-top:0;">
                                ...
                                <a  href="form_fournisseur.jsp" type="button"><span class="glyphicon glyphicon-plus"> Ajouter Un Fournisseur </span></a>
                                </li>
                            </ul>
                    </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <%
	Collection<fourniseur> fournisseur = (Collection<fourniseur>)request.getAttribute("fournisseur");
	for(fourniseur adminn : fournisseur){
%>
<tr><td><%=adminn.getId() %></td><td><%= adminn.getNom_societe() %></td><td><%=adminn.getAdress() %></td><td><%=adminn.getEmail() %></td><td><%=adminn.getTel() %></td><td><a href="edit_fournisseur.jsp?id=<%=adminn.getId() %>" class="btn btn-sm btn-success">Modifier</a></td><td><a href="delete_fournisseur?id=<%=adminn.getId() %>"class="btn btn-sm btn-danger">Supprimer</td></a></td></tr>
<%
	}
%>
                    </table>
