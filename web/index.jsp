<%-- 
    Document   : index
    Created on : 23 janv. 2019, 15:41:22
    Author     : KHALID-RAMI
--%>
...
%>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Accueill <small>Gérer votre site </small></h1>
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 3300</h2>
                    <h4>Medicaments</h4>
                  </div>
                </div>
                <div class="col-md-3">
