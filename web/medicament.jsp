...
<%@page import="com.pharma.entites.fourniseur"%>
<%@page import="com.pharma.entites.medicament"%>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
         <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="Affiche_medicament">Medicament</a></li>
            <li><a href="Affiche_fournissuer">Fournisseur</a></li>
            <li><a href="Affiche_facture">Facture</a></li>
...
%>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> Medicaments <small>Gérer Votre Site</small></h1>
          </div>
          <div class="col-md-2">
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li><a href="index.jsp">Dashboard</a></li>
          <li class="active">Medicaments</li>
        </ol>
      </div>
    </section>
...
//-->
          ...
          <div class="col-md-9">
              ...
              <ul class="pager" style="margin-top:0;">
                                ...
                                <a  href="form_medicament.jsp" type="button"><span class="glyphicon glyphicon-plus"> Ajouter Un Medicament </span></a>
                                </li>
                            </ul>
                    </div>
              ...
              <div class="panel-body">
                ...
                <table class="table table-hover">
                      <tr>
                       ...
                       <%
	Collection<medicament> medicament = (Collection<medicament>)request.getAttribute("medicament");
	for(medicament adminn : medicament){
%>
<tr><td><%=adminn.getId() %></td><td><%= adminn.getNom() %></td><td><%=adminn.getDate_exp() %></td><td><%=adminn.getPrix_achat() %></td><td><%=adminn.getPrix_vendre() %></td><td><%=adminn.getQte() %></td><td><%=adminn.getImage() %></td><td><a href="edit_medicament.jsp?id=<%=adminn.getId() %>" class="btn btn-sm btn-success">Modifier</a> <td><a href="delete_medicament?id=<%=adminn.getId() %>" class="btn btn-sm btn-danger">Supprimer</a></td><td><a href="DisplayServlet?id=<%=adminn.getId() %>" class="btn btn-sm btn-warning">Afficher</a></td></tr>
<%
	}
%>
