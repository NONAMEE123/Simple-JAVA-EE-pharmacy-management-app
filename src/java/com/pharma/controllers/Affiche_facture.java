 ...
 * @author KHALID-RAMI
 */
@WebServlet(name = "Affiche_facture", urlPatterns = {"/Affiche_facture"})
public class Affiche_facture extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FactureDao facturee = new FactureDao();
               Collection<facture> Facture = facturee.findAll();
