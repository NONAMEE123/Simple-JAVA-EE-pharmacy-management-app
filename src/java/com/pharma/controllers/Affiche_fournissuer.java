 ...
 * @author KHALID-RAMI
 */
@WebServlet(name = "Affiche_fournissuer", urlPatterns = {"/Affiche_fournissuer"})
public class Affiche_fournissuer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        FournisseurDao facturee = new FournisseurDao();
               Collection<fourniseur> fournisseur = facturee.findAll();
