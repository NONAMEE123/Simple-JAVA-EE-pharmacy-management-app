 ...
 * @author KHALID-RAMI
 */
@WebServlet(name = "Affiche_medicament", urlPatterns = {"/Affiche_medicament"})
public class Affiche_medicament extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         MedicamentDao adminn = new MedicamentDao();
               Collection<medicament> medicament = adminn.findAll();
