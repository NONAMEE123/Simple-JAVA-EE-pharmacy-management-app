 ...
 * @author KHALID-RAMI
 */
@WebServlet(name = "modifier_facture", urlPatterns = {"/modifier_facture"})
public class modifier_facture extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String date_facture = request.getParameter("date_facture");
		String medicament = request.getParameter("medicament");
               FactureDao d = new FactureDao();
               facture dd = new facture(id, prix_total, date_facture, medicament);
                d.update(dd);
